...
export default function Hero() {
  return (
    <div className='bg-[#F2F0F1] md:bg-white pt-8 max-w-[1024px] mx-auto md:pt-0 md:mb-[107px]'>
      <div className='flex flex-col md:flex-row '>
        <div className='px-4 flex flex-col gap-5 md:my-10 md:w-3/5 md:gap-8'>
          ...
          <button className='text-base text-white bg-black w-full rounded-60 py-4 md:w-fit md:px-12'>
            Shop Now
          </button>
      ...
      <div className='parent md:flex md:justify-around px-4 py-10 bg-black md:absolute md:left-0 md:right-0 '>
